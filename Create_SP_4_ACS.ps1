#************************************#
#  Create/Manage a Service Principle #
#************************************#
...
#***************************************************************************
#   Create Private/Public key-pair in Git Bash or Cmder Mintty in windows  *
#***************************************************************************
# Go to .ssh folder 
cd .ssh

# Invoke ssh-keygen 
# You will be prompted for Pass Phrase and a public/private keypair will be generated in .ssd 
ssh-keygen.exe
